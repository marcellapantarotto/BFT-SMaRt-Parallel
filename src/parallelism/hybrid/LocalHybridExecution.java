 ...
 * @author eduardo
 */
public class LocalHybridExecution {
    ...
    private HybridScheduler scheduler;
    ...
    public static void main(String[] args) {
        ...
        LocalHybridExecution exec = new LocalHybridExecution(entries, lt, np, pG, pW, numReq, gs, hb);
        ...
        try {
            ...
            Logger.getLogger(LocalHybridExecution.class.getName()).log(Level.SEVERE, null, ex);
        }

        System.exit(0);
    }

    public LocalHybridExecution(int entries, int lateThreads, int numberPartitions, int pG, int pW, int numReqs, int graphsize, boolean hibrid) {
        this.hibrid = hibrid;
        this.pg = pG;
        this.pl = pW;
        this.numberPartitions = numberPartitions;
        this.numLate = lateThreads;
        this.scheduler = new HybridScheduler(numberPartitions,
...
//
//                TOMMessage tm = null;
//                List<TOMMessage> tmList = new ArrayList<>();
//                List<Short> tmList = new ArrayList<>();
//                List<Short> opIdList = new ArrayList<>();
//
//                
//                if (i == reqs.length - 1) {
//                    tmList.add(new TOMMessage());
//                }
//
//                if (p == -1) { //GW
...
//                        opIdList.add(opId);
//                        reqs[i] = new MessageContextPair(tmList, em.getClassId(conf),
//                                indexRand.nextInt(maxIndex), (short) 0, opIdList, null);
//                    } else {
//                        opIdList.add( (short) MultipartitionMapping.GW);
//                        reqs[i] = new MessageContextPair(tmList, em.getClassId(allPartitions),
            ...
            while (true) {
                ...
                if (request != null) {
                    ...
                    if (ct.type == HybridClassToThreads.CONC) {
                            ...
                            subgraphs[thread_id].insert(new HybridLockFreeNode(request.msg,
