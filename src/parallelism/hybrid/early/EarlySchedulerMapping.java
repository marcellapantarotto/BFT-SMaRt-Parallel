...
public class EarlySchedulerMapping {
    ...
    public HybridClassToThreads[] CtoT = null;
    ...
    public HybridClassToThreads[] generateMappings(int numPartitions) {
    ...
    public HybridClassToThreads[] generateMappings(int... partitions) {
    ...
    public int getClassIdEarly(String rORw, int... partitions) {
        StringBuilder sb = new StringBuilder();
        for (int j = 0; j < partitions.length; j++) {
            //System.out.print(iv[j]);
            sb.append(partitions[j]);
    ...
    public ClassToThreads[] generateEarly(int numPartitions, int threadsPerPartition) {
    ...
    public void generate(int[] status) {
        ...
        this.CtoT = new HybridClassToThreads[allCombList.size()];
        for (int i = 0; i < this.CtoT.length; i++) {
           ...
           // System.out.println(sb.toString().hashCode());
            ...
            this.CtoT[i] = new HybridClassToThreads(sb.toString().hashCode(), type, ids);
        }
        /*while (i.hasNext()) {
