...
public class BFTListMOMP<V> extends BFTList<V> {
    ...
    public boolean addP2(V[] e) {
        return addFinal(e, em.getClassIdEarly("W",1), MultipartitionMapping.W2);
    }

    public boolean addP3(V[] e) {
        return addFinal(e, em.getClassIdEarly("W",2), MultipartitionMapping.W3);
    }

    public boolean addP4(V[] e) {
        return addFinal(e, em.getClassIdEarly("W",3), MultipartitionMapping.W4);
    }

    public boolean addP5(V[] e) {
        return addFinal(e, em.getClassIdEarly("W",4), MultipartitionMapping.W5);
    }

    public boolean addP6(V[] e) {
        return addFinal(e, em.getClassIdEarly("W",5), MultipartitionMapping.W6);
    }

    public boolean addP7(V[] e) {
        return addFinal(e, em.getClassIdEarly("W",6), MultipartitionMapping.W7);
    }
   ...
   /* public boolean addP1(V[] e) {
    ...
    public boolean containsP2(V[] e) {
        return containsFinal(e, em.getClassIdEarly("R",1), MultipartitionMapping.R2);
    }

    public boolean containsP3(V[] e) {
        return containsFinal(e, em.getClassIdEarly("R",2), MultipartitionMapping.R3);
    }

    public boolean containsP4(V[] e) {
        return containsFinal(e, em.getClassIdEarly("R",3), MultipartitionMapping.R4);
    }

    public boolean containsP5(V[] e) {
        return containsFinal(e, em.getClassIdEarly("R",4), MultipartitionMapping.R5);
    }

    public boolean containsP6(V[] e) {
        return containsFinal(e, em.getClassIdEarly("R",5), MultipartitionMapping.R6);
    }

    public boolean containsP7(V[] e) {
        return containsFinal(e, em.getClassIdEarly("R",6), MultipartitionMapping.R7);
    }
    ...
    public boolean containsFinal(V[] e, int pId, short opId) {
        ...
        //System.out.println(opId+" ReqID CONT: "+pId);
